package Java_Programs._38_Threading.Synchronization.Case_5;

public class P226_SyncDemo5 {
    public static void main(String[] args) {
        ...
        B tb = new B(s1,"B");
        tb.start();
        //yes their will be inconsistencies
        //overall we want them to be run at the concurrently will also happen here
    }
}
class Sync{
